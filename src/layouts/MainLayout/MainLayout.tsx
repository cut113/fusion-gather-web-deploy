        ...
        <div className='flex h-full flex-col overflow-y-auto bg-gray-100 py-4 px-3 shadow-lg'>
          <ul className='space-y-2'>
            ...
            <li>
              ...
              >
                {({ isActive }) => <span className={`ml-3 ${isActive ? 'font-bold' : ''}`}>User</span>}
              </NavLink>
            </li>
            <li>
              <NavLink
              ...
              >
                {({ isActive }) => <span className={`ml-3 ${isActive ? 'font-bold' : ''}`}>Blog</span>}
              </NavLink>
            </li>
          </ul>
          <div className='mt-auto'>
            ©️ Copyright{' '}
            <a href='https://www.facebook.com/duys.lams.58/' target='_blank' rel='noreferrer' className='text-cyan-500'>
              dilamoffical.com
            </a>
          </div>
        </div>
