...
const experimentalCustomFetch = Symbol();
const experimentalUseMtlsAlias = Symbol();
...
function resolveEndpoint(as, endpoint, options) {
    if (options?.[experimentalUseMtlsAlias] && as.mtls_endpoint_aliases && endpoint in as.mtls_endpoint_aliases) {
